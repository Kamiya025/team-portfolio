...
const CustomLink = forwardRef<HTMLAnchorElement, LinkProps>(
  (
    { className, variant = "default", children, external = false, ...props },
    ref
  ) => {
    const baseStyles =
    ...
    const variants = {
      ...
      underline:
        "text-foreground hover:text-blue-600 dark:hover:text-blue-400 underline-offset-4 hover:underline",
    }
